% Use draw.pl to generate separated PDFs
% (or
...
\begin{tikzpicture}[thick]
  ...
  \begin{feynman}\diagram*{#4};\end{feynman}#5%
\end{tikzpicture}
\endpgfgraphicnamed
}

%#job: diagrams_MSSM1
\gmtwodiagram{MSSM1}{$\widetilde \chi^\pm$ or $\widetilde \chi^0$}{$\widetilde\nu_\mu$ or $\widetilde\mu$}{
  (mu1) -- [fermion] (c1),
  (c2) -- [fermion] (mu2),
...
\gmtwodiagram{blob}{}{}{
  ...
  \filldraw[fill=gray](0,-0.2) circle (0.7);
}

%#job: diagrams_vanilla
\gmtwodiagram{vanilla}{}{}{
    (mu1) -- [fermion] (c1p);
    (c2p) -- [fermion] (mu2);
    (cx) -- [boson] (gam);
}{%
